...
CREATE TABLE `User` (
    ...
    `image` VARCHAR(191) NULL DEFAULT '/api/avatar/avatar-default.svg',
...
-- AddForeignKey
ALTER TABLE `Notification` ADD CONSTRAINT `Notification_friendId_fkey` FOREIGN KEY (`friendId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
